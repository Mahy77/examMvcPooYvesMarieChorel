...
<h3>Ajout d'un nouveau véhicule</h3>
...
<form method="post" action="index.php?controller=vehicule&action=addVehicule" class="form-signin" enctype="multipart/form-data">
<div class="form-label-group">
<input type="text" id="marque" name="marque" class="form-control" placeholder="Marque" required autofocus>
<label for="marque">Marque</label>
</div>
<div class="form-label-group">
<input type="text" id="model" name="model" class="form-control" placeholder="Modele" required autofocus>
...
<option value="false" >Boite Manuelle</option>
<option value="1" >Boite Automatique</option>


<div class="form-label-group">
<input type="text" id="image" name="image" class="form-control" placeholder="Image" autofocus>
